...
typedef enum{
    ...
    TDB_ERR_EXT_FAILED = -800,
    TDB_ERR_EXT_CONNECT_FAILED = -801,
    TDB_ERR_EXT_CONNECT_TIMEOUT = -802,
    TDB_ERR_EXT_PATH_TOO_LONG = -803,
    TDB_ERR_EXT_INVALID_RESPONSE = -804,
    TDB_ERR_EXT_SERVER_FAILURE = -805,
    TDB_ERR_EXT_INVALID_HEADER = -806,
    TDB_ERR_EXT_UNSUPPORTED_PROTOCOL = -807,
    TDB_ERR_EXT_NOT_FOUND = -808,
    TDB_ERR_EXT_USERFAULT_NOT_SUPPORTED = -809,
